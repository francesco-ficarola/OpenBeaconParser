...
/** Implementation of the sketches by Flajolet and Martin */
public class FlajoletMartinSketch {
    private static final double PHI = 0.77351D;
    private int bitmapSize;
    private int numHashes;
    private FM_HashFunction[] hashes;
    private boolean[][] bitmaps; // bitmaps[i] is the bitmap for the i-th hash function
    ...
    /** Case in which we need all FM sketches of nodes to have the same hash functions */
